...
* Juega escribiendo 'xd' hasta que termine el tiempo dado por el programa.
* Al final se contará tus aciertos.
...
1.  **Navega a la Carpeta del Proyecto**:
    Abre la carpeta `Expo-Técnica` en el Explorador de Archivos. En la barra de dirección superior, haz clic, escribe `cmd` y presiona Enter. Esto abrirá la consola directamente en la ubicación del proyecto.
...
Tienes 60 segundos para escribir 'xd' y presionar Enter.
